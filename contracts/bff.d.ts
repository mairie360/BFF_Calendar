...
export interface paths {
    ...
    "/calendar/bootstrap": {
        ...
        get: {
            parameters: {
                query?: {
                    /** @description Date de début au format YYYY-MM-DD (défaut : premier jour du mois courant) */
                    from?: string;
                    /** @description Date de fin au format YYYY-MM-DD (défaut : dernier jour du mois courant) */
                    to?: string;
                };
                header?: never;
                path?: never;
